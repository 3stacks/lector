...
export default function NavHeader() {
  ...
  return (
    <>
      ...
      <header className="hidden sm:block sticky top-0 z-50 w-full border-b border-zinc-200 bg-white/80 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-950/80">
